    ...
    <Section className="relative overflow-hidden bg-brand-navy text-white">
      ...
      <Container className="relative grid items-center gap-10 md:grid-cols-2">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="mx-auto mt-4 max-w-xl text-white/80 md:mx-0">More than a delivery service — a community built on better hydration. When you order from Leo&apos;s, you join the <b>Water Fam</b>: neighbors across Indianapolis choosing living, alkaline water every day.</p>
        </div>
      </Container>
    </Section>
  );
