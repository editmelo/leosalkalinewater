  ...
  return (
    <Section>
      <Container className="flex flex-col items-center gap-8 md:flex-row">
        <div className="relative h-44 w-44 shrink-0 overflow-hidden rounded-full shadow-lg">
          <Image src="/leo.avif" alt="Leonardo Colon, founder of Leo's Alkaline Water" fill className="object-cover" sizes="176px" />
        </div>
        <div>
