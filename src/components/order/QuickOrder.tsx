  ...
  return (
    <Card className="mx-auto w-full max-w-sm text-center">
      ...
      <p className="mt-3 text-4xl font-extrabold text-brand-navy">
        $15<span className="text-lg font-semibold text-brand-text/60"> / 5-gal jug</span>
      </p>
      <p className="mb-5 mt-1 text-sm text-brand-text/70">Every jug is a 5-gallon jug. Pick how many &amp; how often.</p>
